...
RageUI.Settings = {
    ...
    Items = {
        Title = {
            ...
            Text = { X = 215, Y = 28, Scale = 0.85 },
        },
        Subtitle = {
            Background = { Width = 431, Height = 8 },
            Text = { X = 8, Y = 3, Scale = 0 },
        ...
        Description = {
            ...
            Background = { Dictionary = "commonmenu", Texture = "gradient_bgd", Y = 4, Width = 432, Height = 25 },
